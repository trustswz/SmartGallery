...
public final class Constants {
	...
	public static class Extra {
		...
		public static final String IMAGE_TAG_NAME = "imagic.mobile.clarifai.IMAGE_TAG_NAME";
		public static final String IMAGE_URLS = "imagic.mobile.clarifai.IMAGE_URLS";
		public static final String TAG_NAME_LIST = "imagic.mobile.clarifai.TAG_NAME_LIST";
		public static final String TAG_NAME_LIST_NUMBER_OF_IMAGES = "imagic.mobile.clarifai.TAG_NAME_LIST_NUMBER_OF_IMAGES";
		public static final String TAG_NAME_LIST_IMAGE_URLS = "imagic.mobile.clarifai.TAG_NAME_LIST_IMAGE_URLS";
	}
}
